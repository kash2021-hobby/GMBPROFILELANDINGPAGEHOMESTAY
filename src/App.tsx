        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <button className="bg-white text-blue-900 p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group">
              <img src="/b91b6ca67e27dc9e2f69544395df2a0a.png" alt="Google" className="w-28 h-28 mx-auto mb-4 object-contain group-hover:scale-110 transition-transform opacity-100" />
            ...
            <button className="bg-white text-blue-900 p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group">
              <div className="relative w-20 h-20 mx-auto mb-4 group-hover:scale-110 transition-transform">
                <img src="/162feb52-d9c8-464f-83cd-98b299c0ea23_blurred.png" alt="OYO" className="w-full h-full object-contain" />
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl w-full aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/bhKofPzDS3g?modestbranding=1&rel=0&controls=1&autoplay=1&mute=1&loop=1&playlist=bhKofPzDS3g"
