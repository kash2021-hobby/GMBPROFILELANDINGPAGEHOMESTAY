      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <button className="bg-white text-blue-900 p-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group">
              <h3 className="font-bold text-lg mb-4">10X MORE GOOGLE RATING REVIEWS</h3>
              <div className="bg-gray-800 rounded-lg px-4 py-2 mx-auto inline-flex items-center justify-center shadow-md">
                <span className="text-2xl font-bold text-white mr-2">4.5</span>
                <div className="flex">
                ...
                <span className="text-sm text-gray-300 ml-2">(8.6K)</span>
              </div>
            </button>
          </div>
        </div>
